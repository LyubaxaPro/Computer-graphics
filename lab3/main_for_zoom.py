...
from PyQt5.QtGui import QPen, QColor, QImage, QPixmap, QKeyEvent, QWheelEvent
...
class GraphicsViewer(QtWidgets.QGraphicsView):
    ...
    def __init__(self, parent):
        ...
        self._zoom = 1
        self._empty = True
        self._scene = QtWidgets.QGraphicsScene(0, 0, 650, 650)
        self._image = QtWidgets.QGraphicsPixmapItem()
        # self._image.scaled(QSize(64, 64))
        ...
        self.setBackgroundBrush(QtGui.QBrush(QtGui.QColor(30, 0, 30)))
    ...
    def mousePressEvent(self, event):
        ...
        super(GraphicsViewer, self).mousePressEvent(event)


class Window(QtWidgets.QMainWindow, lab3_interface.Ui_MainWindow, QtWidgets.QWidget):
    def __init__(self):
        ...
        self.scene = self.viewer.getScene()
        # self.scene.se
        # self.scene.win = self
...
def draw_image_from_pix(window):
    ...
    window.viewer.setPhoto(QPixmap('/home/maksim/Desktop/fon/drawable-hdpi/big_2.png'))
...
def showDialog():
   ...
   msgBox.setWindowTitle("Эта операция недоступна для стандартного алгоритма")
